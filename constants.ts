...
export const LESSON_SCHEDULE: DailySchedule = {
  1: [ // ორშაბათი (6 გაკვეთილი)
    ...
    { subject: 'გეოგრაფია', teacher: 'სოფიკო ნიკურაძე' },
    { subject: 'მოქალაქეობა', teacher: 'ნინო გიორგაძე' },
    { subject: 'საქართველოს ისტორია', teacher: 'დიმიტრი ღონღაძე' },
  ...
  2: [ // სამშაბათი (6 გაკვეთილი)
    ...
    { subject: 'ქიმია', teacher: 'მადინა ბაღდავაძე' },
    { subject: 'ისტორია', teacher: 'დიმიტრი ღონღაძე' },
  ],
  3: [ // ოთხშაბათი (5 გაკვეთილი)
    { subject: 'საქართველოს ისტორია', teacher: 'დიმიტრი ღონღაძე' },
    { subject: 'ქართული ენა', teacher: 'ეკატერინე მდივანი' },
    { subject: 'გეოგრაფია', teacher: 'სოფიკო ნიკურაძე' },
    { subject: 'რუსული / გერმანული', teacher: 'ლია ობოლაძე / ლანა ნადარეიშვილი' },
    { subject: 'პროექტი - მოქალაქეობა', teacher: 'ზაურბეგ ტატაევი' },
  ],
  4: [ // ხუთშაბათი (6 გაკვეთილი)
    { subject: 'მათემატიკა', teacher: 'მარინა ხუციშვილი' },
    { subject: 'ბიოლოგია', teacher: 'მარინე ნიკოლაიშვილი' },

...
export const LESSON_SCHEDULE: DailySchedule = {
  1: [ // ორშაბათი
    ...
    { subject: 'რუსული / გერმანული', teacher: 'ობოლაძე / ნადირაძე' },
    { subject: 'ქართული ენა და ლიტერატურა', teacher: 'მდივანი' },
    { subject: 'მათემატიკა', teacher: 'ხუციშვილი' },
    { subject: 'ისტორია', teacher: 'დ. ღონღაძე' },
    { subject: 'კომპიუტერული მეცნიერება', teacher: 'აბულაძე' },
  ],
  2: [ // სამშაბათი
    { subject: 'მათემატიკა', teacher: 'ხუციშვილი' },
  ...
  5: [ // პარასკევი
    ...
    { subject: 'მათემატიკა', teacher: 'ხუციშვილი' },
    { subject: 'ქართული ენა და ლიტერატურა', teacher: 'მდივანი' },
    { subject: 'სახვითი და გამოყენებითი ხელოვნება', teacher: 'ენდელაძე' },
    { subject: 'ფიზიკა', teacher: 'მ. დვალი' },
    { subject: 'პროექტული მოქალაქეობა', teacher: 'ტატაევი' },
    { subject: 'რუსული / გერმანული', teacher: 'ობოლაძე / ნადირაძე' },
  ],
};
